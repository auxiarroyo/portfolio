...
const PROJECT: {
    ...
    category: { es: "UX/UI · Mobile App", en: "UX/UI · Mobile App" },
    title: { es: "Nailing", en: "Nailing" },
    year: "2026",
    role: {
        es: "UX Research · UI Design · Prototipado",
        en: "UX Research · UI Design · Prototyping",
    },
    client: {
    ...
    lead: {
        es: "Nailing conecta a las personas con estudios de uñas y nail artists cercanos, y hace que reservar una cita sea tan fácil como elegir tu diseño favorito.",
        en: "Nailing connects people with nearby nail studios and nail artists, making booking an appointment as easy as choosing your favourite design.",
    },
    overview: {
        es: [
            "Nailing es una app de belleza centrada en el mundo de las uñas: descubrir inspiración, encontrar estudios y profesionales freelance, y reservar sesiones en pocos pasos. La experiencia busca ser visual, cálida y sin fricción.",
            "El objetivo era resolver un proceso que hoy vive disperso entre Instagram, WhatsApp y el boca a boca, reuniéndolo en un único flujo claro: inspirarse, elegir, reservar.",
        ],
        en: [
            "Nailing is a beauty app focused on the world of nails: discovering inspiration, finding studios and freelance professionals, and booking sessions in a few steps. The experience aims to be visual, warm and frictionless.",
            "The goal was to solve a process that today is scattered across Instagram, WhatsApp and word of mouth, bringing it into a single clear flow: get inspired, choose, book.",
        ],
    },
    services: {
        es: ["UX Research", "Arquitectura de la información", "User Flows", "Wireframing", "UI Design", "Prototipado"],
        en: ["UX Research", "Information Architecture", "User Flows", "Wireframing", "UI Design", "Prototyping"],
    },
    quote: {
        es: "Reservar tu próxima cita de uñas debería ser tan bonito como el resultado.",
        en: "Booking your next nail appointment should feel as beautiful as the result.",
    },
    sections: [
        {
            key: "problem",
            ...
            body: {
                es: [
                    "Encontrar un buen estudio de uñas o un nail artist de confianza suele implicar saltar entre redes sociales, reseñas dispersas y mensajes directos para preguntar disponibilidad y precios.",
                    "Objetivo UX: unificar descubrimiento, comparación y reserva en una sola app, reduciendo pasos y aportando confianza antes de reservar.",
                ],
                en: [
                    "Finding a good nail studio or a trusted nail artist usually means jumping between social media, scattered reviews and direct messages to ask about availability and prices.",
                    "UX goal: unify discovery, comparison and booking in a single app, reducing steps and building confidence before booking.",
                ],
            },
        },
        {
            ...
            body: {
                es: [
                    "Analicé referentes de apps de belleza y reserva, mapeé el recorrido actual del usuario y detecté los momentos de fricción: ubicación, confianza en el profesional y claridad de precios.",
                    "Perfiles objetivo: personas que cuidan su imagen y buscan comodidad, y nail artists que quieren gestionar clientes y agenda desde un mismo lugar.",
                ],
                en: [
                    "I studied beauty and booking app references, mapped the current user journey and spotted friction points: location, trust in the professional and price clarity.",
                    "Target users: people who care about their image and want convenience, and nail artists who want to manage clients and schedule from one place.",
                ],
            },
        },
        {
            ...
            body: {
                es: [
                    "Diseñé los flujos clave —descubrir, explorar un estudio o profesional y reservar— desde wireframes hasta alta fidelidad, iterando la navegación y la jerarquía de cada pantalla.",
                    "El flujo de reserva se resolvió en pasos guiados: servicio, método de pago, fecha y hora, y confirmación, manteniendo siempre el contexto visible.",
                ],
                en: [
                    "I designed the key flows — discover, explore a studio or professional, and book — from wireframes to high fidelity, iterating navigation and the hierarchy of each screen.",
                    "The booking flow was resolved into guided steps: service, payment method, date and time, and confirmation, always keeping context visible.",
                ],
            },
        },
        {
            ...
            body: {
                es: [
                    "El sistema se apoya en una fotografía cálida y un acento coral que aporta energía y cercanía, con tarjetas suaves, esquinas redondeadas y mucho aire.",
                    "Componentes reutilizables, tipografía clara y diseño responsive garantizan coherencia en toda la app y facilidad para crecer.",
                ],
                en: [
                    "The system relies on warm photography and a coral accent that brings energy and closeness, with soft cards, rounded corners and plenty of breathing room.",
                    "Reusable components, clear typography and responsive design ensure consistency across the app and room to grow.",
                ],
            },
        },
        {
            ...
            body: {
                es: [
                    "El prototipo permite recorrer de principio a fin el descubrimiento y la reserva de una cita, comunicando con claridad la propuesta de valor del producto.",
                    "Métricas a validar: facilidad de reserva, tasa de finalización del flujo, confianza percibida y satisfacción (SUS).",
                ],
                en: [
                    "The prototype lets you go end to end through discovering and booking an appointment, clearly communicating the product's value proposition.",
                    "Metrics to validate: booking ease, flow completion rate, perceived trust and satisfaction (SUS).",
                ],
            },
        },
        {
            ...
            body: {
                es: [
                    "Nailing me permitió diseñar un producto muy visual manteniendo la usabilidad, equilibrando estética y claridad en cada decisión de interfaz.",
                    "Próximos pasos: test con usuarios reales, incorporar reseñas y valoraciones, y diseñar el lado del profesional para gestionar su agenda.",
                ],
                en: [
                    "Nailing let me design a highly visual product while keeping usability, balancing aesthetics and clarity in every interface decision.",
                    "Next steps: testing with real users, adding reviews and ratings, and designing the professional side to manage their schedule.",
                ],
            },
        },
    ],
...
/**
 * Nailing — UX/UI Case Study — Auxi Arroyo García
 *
...
export default function NailingPage(props: NailingPageProps) {
    const {
        profileImage,
        email = EMAIL,
                ...
                >
                    <div className="pd-intro-sticky">
                        <div className="pd-hero-bg" aria-hidden="true">
                            <img src={IMG.showcase[1]} alt="" loading="eager" decoding="async" draggable={false} />
...
addPropertyControls(NailingPage, {
    profileImage: {
...
.pd-hero-bg img { width: 100%; height: 100%; object-fit: cover; object-position: center; transform: scale(1.1); filter: blur(2px); }
.pd-hero-scrim {
