...
/* ---------------------------------------------------------------------------
   ...
   to Framer. The showcase is the hero mockup; the galleries scroll horizontally.
--------------------------------------------------------------------------- */
const IMG = {
    showcase: [
...
const LIGHTBOX_IMAGES: string[] = Array.from(
    new Set([...IMG.showcase, ...IMG.screens, ...IMG.wires])
)
/* Gallery captions + product-preview label, per language. */
const CAP = {
    es: {
        showcase: "Vista del producto",
        wires: "Wireframes — exploración inicial de flujos y estructura.",
        screens: "Pantallas finales de alta fidelidad.",
    },
    en: {
        showcase: "Product preview",
        wires: "Wireframes — early exploration of flows and structure.",
...
const PROJECT: {
    ...
    year: "2026",
    role: {
        es: "UX Research · Product Design · UI",
        en: "UX Research · Product Design · UI",
    },
    client: {
        es: "EmprendeUCO · Universidad de Córdoba",
        en: "EmprendeUCO · University of Córdoba",
    },
    lead: {
        es: "Youicy convierte la búsqueda de empleo en un proceso guiado, medible y motivador: objetivos pequeños, progreso visible y menos incertidumbre.",
        en: "Youicy turns the job search into a guided, measurable and motivating process: small goals, visible progress and less uncertainty.",
    },
    overview: {
        es: [
            "Youicy es una plataforma que acompaña a personas en búsqueda de empleo mediante objetivos, métricas, recursos y seguimiento del progreso. El proyecto explora cómo el diseño centrado en el usuario puede reducir la incertidumbre y aumentar la constancia durante un proceso habitualmente frustrante.",
            "Se desarrolló durante mi participación en EmprendeUCO, el programa de emprendimiento de la Universidad de Córdoba, donde la idea evolucionó desde la investigación del problema hasta una propuesta de producto digital validada con mentores.",
        ],
        en: [
            "Youicy is a platform that supports job seekers through goals, metrics, resources and progress tracking. The project explores how user-centred design can reduce uncertainty and build consistency during a process that is usually frustrating.",
            "It was developed during my time at EmprendeUCO, the entrepreneurship programme of the University of Córdoba, where the idea evolved from problem research into a digital product proposal validated with mentors.",
        ],
    },
    services: {
        es: ["UX Research", "Arquitectura de la información", "User Flows", "Wireframing", "UI Design", "Prototipado", "Testing"],
        en: ["UX Research", "Information Architecture", "User Flows", "Wireframing", "UI Design", "Prototyping", "Testing"],
    },
    quote: {
        es: "Un entrenador personal de empleabilidad que convierte la búsqueda de empleo en un proceso guiado, medible y gamificado.",
        en: "A personal employability coach that turns the job search into a guided, measurable and gamified process.",
    },
    sections: [
        {
            key: "problem",
            ...
            body: {
                es: [
                    "Buscar empleo suele ser un proceso desestructurado: ghosting, baja motivación, dificultad para medir el progreso y ausencia de una guía personalizada.",
                    "Objetivo UX: diseñar una experiencia que ayude a crear hábitos, visualizar el progreso y reducir la sensación de incertidumbre mediante pequeños objetivos alcanzables.",
                ],
                en: [
                    "Job hunting is usually an unstructured process: ghosting, low motivation, difficulty measuring progress and no personalised guidance.",
                    "UX goal: design an experience that helps build habits, visualise progress and reduce the feeling of uncertainty through small, achievable goals.",
                ],
            },
        },
        {
            key: "research",
            heading: { es: "Investigación", en: "Research" },
            body: {
                es: [
                    "Partí de desk research y un benchmark de plataformas de empleo para definir hipótesis, identificar pain points y detectar oportunidades de diseño.",
                    "Perfiles objetivo: estudiantes, recién graduados, personas desempleadas y profesionales en transición laboral.",
                ],
                en: [
                    "I started with desk research and a benchmark of job platforms to define hypotheses, identify pain points and spot design opportunities.",
                    "Target users: students, recent graduates, unemployed people and professionals in career transition.",
                ],
            },
        },
        {
            key: "process",
            heading: { es: "Proceso UX/UI", en: "UX/UI process" },
            body: {
                es: [
                    "El proyecto siguió un proceso completo: investigación, definición del problema, ideación, arquitectura de la información, user flows, wireframes, diseño UI, prototipo interactivo, testing e iteración.",
                    "El MVP incluye onboarding personalizado, dashboard de progreso, objetivos semanales, checklist diaria, recursos, historial, perfil y un resumen compartible.",
                ],
                en: [
                    "The project followed a full process: research, problem definition, ideation, information architecture, user flows, wireframes, UI design, interactive prototype, testing and iteration.",
                    "The MVP includes personalised onboarding, a progress dashboard, weekly goals, a daily checklist, resources, history, profile and a shareable summary.",
                ],
            },
        },
        {
            key: "system",
            heading: { es: "Sistema de diseño", en: "Design system" },
            body: {
                es: [
                    "Construí un sistema con componentes reutilizables, tipografía consistente y una jerarquía visual clara, cuidando la accesibilidad y el diseño responsive.",
                    "El lenguaje visual —navy, menta y acentos cálidos— transmite calma y progreso, alejándose del tono ansioso habitual en la búsqueda de empleo.",
                ],
                en: [
                    "I built a system with reusable components, consistent typography and a clear visual hierarchy, with care for accessibility and responsive design.",
                    "The visual language — navy, mint and warm accents — conveys calm and progress, moving away from the anxious tone usual in job hunting.",
                ],
            },
        },
        {
            key: "results",
            heading: { es: "Resultados", en: "Results" },
            body: {
                es: [
                    "Definí KPIs para medir el impacto: conversión de registro, objetivos completados, retención semanal, usuarios activos, escala SUS y finalización de tareas.",
                    "El roadmap se planteó a 12 semanas: investigación, arquitectura y wireframes, diseño UI, prototipo, testing, iteraciones y presentación final.",
                ],
                en: [
                    "I defined KPIs to measure impact: sign-up conversion, completed goals, weekly retention, active users, the SUS scale and task completion.",
                    "The roadmap was planned across 12 weeks: research, architecture and wireframes, UI design, prototype, testing, iterations and a final presentation.",
                ],
            },
        },
        {
            key: "learnings",
            heading: { es: "Aprendizajes", en: "Learnings" },
            body: {
                es: [
                    "El proyecto me permitió trabajar un proceso completo de Product Design, desde la investigación hasta la validación de una solución digital, reforzando UX Research, diseño de interacción y pensamiento estratégico.",
                    "Próximos pasos: validación con usuarios reales, definición del roadmap de producto, implementación del MVP y análisis de métricas de uso.",
                ],
                en: [
                    "The project let me work through a complete Product Design process, from research to validating a digital solution, strengthening UX Research, interaction design and strategic thinking.",
                    "Next steps: validation with real users, defining the product roadmap, implementing the MVP and analysing usage metrics.",
                ],
            },
        },
    ],
...
const RELATED: {
    ...
    {
        key: "nailly",
        category: { es: "UX/UI · App móvil", en: "UX/UI · Mobile app" },
...
function SectionNav({
    ...
    /* hide the index once the reader reaches "Keep exploring" / the footer */
    useEffect(() => {
        if (!hideAtId) return
        if (typeof window === "undefined" || typeof IntersectionObserver === "undefined") return
        const stop = document.getElementById(hideAtId)
        if (!stop) return
        const obs = new IntersectionObserver(
            (entries) => {
    ...
    const jump = useCallback((id: string) => { go(id); setOpen(false) }, [go])
    useEffect(() => {
    ...
    return (
        <div
            className={"pd-secnav" + (open ? " is-open" : "") + (hidden ? " is-hidden" : "")}
            ref={rootRef}
...
/* ---------------------------------------------------------------------------
   PHONE GALLERY — a horizontally scrollable row of portrait app screens.
   Native scroll-snap keeps it smooth and touch-friendly on every device; the
   whole figure reveals on scroll with the page's signature blur→sharp.
--------------------------------------------------------------------------- */
function PhoneGallery({ images, caption, onOpen }: { images: string[]; caption?: string; onOpen?: (src: string) => void }) {
    return (
        <Reveal blur tag="figure" className="cs-figure">
            <div className="cs-gallery" role="list">
                {images.map((src, i) => (
                    <span
                        className="cs-phone cs-phone--btn"
                        role="button"
                        tabIndex={0}
                        key={i}
...
/* ---------------------------------------------------------------------------
   LIGHTBOX — fullscreen image viewer: prev/next, keyboard + swipe, counter.
--------------------------------------------------------------------------- */
function Lightbox({
    images,
    index,
    ...
    return (
        <div className="pd-lb" role="dialog" aria-modal="true" aria-label={labels.close} onClick={onClose}>
            <button type="button" className="pd-lb-close" onClick={onClose} aria-label={labels.close}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 6l12 12M18 6L6 18" /></svg>
            </button>
            <button type="button" className="pd-lb-nav pd-lb-nav--prev" onClick={(e) => { e.stopPropagation(); go(-1) }} aria-label={labels.prev}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M15 6l-6 6 6 6" /></svg>
            </button>
            <figure className="pd-lb-stage" onClick={(e) => e.stopPropagation()} onPointerDown={onDown} onPointerUp={onUp}>
                <img className="pd-lb-img" src={images[index]} alt="" draggable={false} />
                <figcaption className="pd-lb-count">{index + 1} / {images.length}</figcaption>
            </figure>
            <button type="button" className="pd-lb-nav pd-lb-nav--next" onClick={(e) => { e.stopPropagation(); go(1) }} aria-label={labels.next}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 6l6 6-6 6" /></svg>
            </button>
        </div>
    )
}
...
/**
 * Youicy — UX/UI Case Study — Auxi Arroyo García
 *
...
export default function YouicyPage(props: YouicyPageProps) {
    const {
        profileImage,
        email = EMAIL,
    ...
    const openLb = useCallback((src: string) => {
        const i = LIGHTBOX_IMAGES.indexOf(src)
        setLbIndex(i >= 0 ? i : 0)
    }, [])
    ...
    return (
        ...
        >
            ...
            >
                ...
                <section
                    className={`pd-intro pd-intro--immersive ${animate ? "" : "pd-intro--flat"}`}
                    ref={introRef}
                ...
                >
                    <div className="pd-intro-sticky">
                        <div className="pd-hero-bg" aria-hidden="true">
                            <img src={HERO_BG} alt="" loading="eager" decoding="async" draggable={false} />
                            <span className="pd-hero-scrim" />
                        </div>
                        <div
                            className="pd-hero"
                            style={heroStyle}
                ...
                <article className="pd-story">
                    ...
                    {/* product showcase — hero mockup (three key screens) */}
                    <section className="aag-section pd-mediablock" aria-label={CAP[lang].showcase}>
                        <Reveal blur className="cs-showcase">
                            <div className="cs-showcase-row">
                                {IMG.showcase.map((src, i) => (
                                    <span
                                        className={"cs-phone cs-phone--btn" + (i === 1 ? " cs-phone--hero" : "")}
                                        key={i}
                                        role="button"
                                        tabIndex={0}
                                        onClick={() => openLb(src)}
                    ...
                    {p.sections.map((sec, si) => (
                        ...
                        >
                            ...
                            {sec.key === "research" ? (
                                <PhoneGallery images={IMG.wires} caption={CAP[lang].wires} onOpen={openLb} />
                            ) : null}
                            {sec.key === "process" ? (
                                <PhoneGallery images={IMG.screens} caption={CAP[lang].screens} onOpen={openLb} />
                            ) : null}
                        </section>
                    ))}

                    {/* ---------- KEEP EXPLORING — related project cards ---------- */}
                    <section className="aag-section pd-next" id="pd-next" aria-label={t.nextEyebrow}>
                        <Reveal blur>
            ...
            {/* ===================== FLOATING UI (section nav · lightbox · back to top · status pill) =====================
                Portalled into body so position:fixed resolves against the window,
                not against Framer's clipped page frame. Without this the lightbox
                opened off-screen when triggered from far down the case study. */}
            {portalHost && createPortal(
                <>
                    <SectionNav items={sectionNavItems} label={t.overviewLabel} hideAtId="pd-next" />
...
addPropertyControls(YouicyPage, {
    profileImage: {
...
.pd-intro--immersive .pd-hero { position: relative; z-index: 1; }
.pd-intro--immersive .pd-hero-title { color: #fff; text-shadow: 0 2px 30px rgba(0,0,0,0.28); }
.pd-intro--immersive .pd-hero-cat { color: #fff; opacity: 0.94; }
.pd-intro--immersive .pd-scrollcue-label { color: rgba(255,255,255,0.86); }
.pd-intro--immersive .pd-scrollcue-line { background: linear-gradient(to bottom, rgba(255,255,255,0.86), transparent); }
.pd-intro--immersive.pd-intro--flat .pd-intro-sticky { position: relative !important; }

/* ---------- CLICKABLE SCREENS + LIGHTBOX ---------- */
.cs-phone--btn { cursor: pointer; }
.cs-phone--btn:focus-visible { outline: 2px solid var(--accent); outline-offset: 3px; }
.pd-lb {
    ...
    animation: pd-lb-in 0.24s ease both;
}
@keyframes pd-lb-in { from { opacity: 0; } to { opacity: 1; } }
.pd-lb-stage { position: relative; display: flex; flex-direction: column; align-items: center; gap: 14px; max-width: 100%; max-height: 100%; touch-action: pan-y; }
.pd-lb-img {
    max-width: min(88vw, 520px); max-height: 78vh;
    width: auto; height: auto; object-fit: contain;
    border-radius: 18px; box-shadow: 0 30px 80px rgba(0,0,0,0.5);
    background: #fff; -webkit-user-select: none; user-select: none;
}
.pd-lb-count { font-size: 13px; font-weight: 600; letter-spacing: 0.04em; color: rgba(255,255,255,0.86); }
.pd-lb-close, .pd-lb-nav {
    ...
    border-radius: 999px; cursor: pointer; -webkit-backdrop-filter: blur(8px); backdrop-filter: blur(8px);
    transition: background 0.2s ease, transform 0.2s ease;
}
.pd-lb-close:hover, .pd-lb-nav:hover { background: rgba(255,255,255,0.24); }
.pd-lb-close { top: clamp(14px, 3vw, 26px); right: clamp(14px, 3vw, 26px); width: 44px; height: 44px; }
.pd-lb-nav { top: 50%; transform: translateY(-50%); width: 52px; height: 52px; }
.pd-lb-nav:hover { transform: translateY(-50%) scale(1.06); }
.pd-lb-nav--prev { left: clamp(10px, 3vw, 34px); }
.pd-lb-nav--next { right: clamp(10px, 3vw, 34px); }
@media (max-width: 700px) {
    .pd-lb-nav { width: 44px; height: 44px; }
    .pd-lb-nav--prev { left: 8px; }
    .pd-lb-nav--next { right: 8px; }
    .pd-lb-img { max-width: 92vw; max-height: 72vh; }
}
@media (prefers-reduced-motion: reduce) {
    .pd-lb { animation: none; }
}
...
/* ==========================================================================
   CASE STUDY MEDIA — product showcase + horizontal phone galleries
   ========================================================================== */
/* portrait app screen — shared framing for showcase + galleries */
.cs-phone {
    flex: 0 0 auto;
    display: block;
...
/* product showcase — soft branded panel holding the three key screens */
.cs-showcase {
    width: 100%;
    border-radius: clamp(22px, 3vw, 34px);
    background:
        radial-gradient(120% 120% at 50% -10%, rgba(255,101,77,0.10) 0%, rgba(255,101,77,0) 55%),
        linear-gradient(160deg, #f2f2ef 0%, #ffffff 48%, #eef0ef 100%);
    border: 1px solid var(--border);
    box-shadow: var(--shadow);
...
.cs-showcase .cs-phone {
    width: clamp(150px, 20vw, 244px);
    box-shadow: 0 26px 60px rgba(0,0,0,0.18);
}
.cs-showcase .cs-phone--hero {
    transform: translateY(-22px) scale(1.04);
    z-index: 2;
    box-shadow: 0 34px 70px rgba(0,0,0,0.22);
}
.cs-showcase .cs-phone:first-child { transform: translateY(10px) rotate(-2.5deg); }
.cs-showcase .cs-phone:last-child { transform: translateY(10px) rotate(2.5deg); }
...
.cs-gallery .cs-phone { scroll-snap-align: center; }
.cs-gallery .cs-phone:hover { transform: translateY(-4px); box-shadow: 0 24px 54px rgba(0,0,0,0.18); }
.cs-caption {
    margin-top: 8px;
    font-size: 13px;
    font-weight: 500;
...
.aag-static .cs-phone, .aag-static .cs-phone--hero { transform: none !important; }

@media (max-width: 760px) {
    .cs-showcase-row { justify-content: flex-start; overflow-x: auto; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch; scrollbar-width: none; padding-bottom: 6px; }
    .cs-showcase-row::-webkit-scrollbar { display: none; }
    .cs-showcase .cs-phone { scroll-snap-align: center; width: clamp(178px, 56vw, 230px); }
    .cs-showcase .cs-phone,
    .cs-showcase .cs-phone--hero,
    .cs-showcase .cs-phone:first-child,
    .cs-showcase .cs-phone:last-child { transform: none; }
}
@media (max-width: 480px) {
    .cs-phone { width: clamp(200px, 68vw, 240px); border-radius: 26px; }
}
